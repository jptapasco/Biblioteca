...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponentsAltern(){
        ...
        Image img_candado = getToolkit().createImage(ClassLoader.getSystemResource("imagenes/imagen_login.jpg"));
        img_candado = img_candado.getScaledInstance(170, 170, Image.SCALE_SMOOTH);
